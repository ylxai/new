...
export const metadata: Metadata = {
  title: 'Kontak Kami - Hafiportrait Gallery',
  description: 'Hubungi Hafiportrait Gallery untuk konsultasi dan pemesanan jasa fotografi profesional',
};
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-2 text-lg leading-8 text-gray-600">
            Kami siap membantu Anda untuk mendokumentasikan momen berharga dalam hidup Anda.
          </p>
        </div>
              ...
              <div>
                ...
                <div className="mt-2">
                  <textarea
                    ...
                    rows={4}
                    className="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6"
                    placeholder="Ceritakan tentang acara Anda dan kebutuhan fotografi yang Anda inginkan..."
                  />
                </div>
              </div>
              <div>
            ...
            <div>
              ...
              <dl className="space-y-6 text-base leading-7 text-gray-600">
                <div className="flex gap-x-4">
                  ...
                  <dd>Jl. Raya Fotografer No. 123<br />Kota Bandung, Jawa Barat 40123</dd>
                </div>
                <div className="flex gap-x-4">
                  <dt className="flex-none">
                  ...
                  <dd>
                    <a className="hover:text-blue-600" href="tel:+6281234567890">
                      +62 812-3456-7890
                    </a>
                  </dd>
                </div>
                <div className="flex gap-x-4">
                  ...
                  <dd>
                    <a className="hover:text-blue-600" href="mailto:info@hafiportrait.com">
        ...
        <div className="mt-16 rounded-lg overflow-hidden shadow-md">
          <div className="bg-gray-200 h-96 w-full flex items-center justify-center">
            ...
            {/* <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3960.7976763744283!2d107.6086!3d-6.9039!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zNsKwNTQnMTQuMCJTIDEwN8KwMzYnMzEuMCJF!5e0!3m2!1sen!2sid!4v1620000000000!5m2!1sen!2sid"
              width="100%"
              height="100%"
              style={{ border: 0 }}
              allowFullScreen
